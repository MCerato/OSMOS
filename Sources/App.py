...
# *************
        ...
        selectFileFrame.grid(row = 0, column = 0, rowspan = 2, pady = 10, 
                             padx = 10)

# *************
        self.filePathLbl = ttk.Label(selectFileFrame,
                              text = "CB File Path")
        self.filePathLbl.grid(row = 0, column = 0, pady = 10, padx = 10,
                              sticky = "W")

# *************
        self.FileNameLbl = ttk.Label(selectFileFrame,
...
# *************
        self.openFileBtn = ttk.Button(selectFileFrame, text ='import Command file', 
...
# *************
        ...
        configFrame.grid(row = 0, column = 1, rowspan = 2, pady = 10,
                          padx = 10)

# *************
        self.ntwrkLbl = ttk.Label(configFrame,
                              text = "SOLEIL Network :")
        self.ntwrkLbl.grid(row = 0, column = 0, pady = 10, padx = 0, 
                           sticky = "W")
# *************
        self.IPLbl = ttk.Label(configFrame,
                              text = "IP Address")
        self.IPLbl.grid(row = 1, column = 0, pady = 10, padx = 0, 
                           sticky = "W")
...
# *************
        ...
        commandFrame.grid(row = 0, column = 2, rowspan = 2, pady = 10,
                          padx = 10)
...
# *************
        self.stopBtn = ttk.Button(commandFrame, text ='Stop (disabled)', 
...
# *************
        self.configProgress = ttk.Progressbar(progressFrame, orient = tk.HORIZONTAL,
                                    length=100, mode = 'indeterminate')
        self.configProgress.grid(row = 0, column = 0, rowspan = 2, columnspan = 4, pady = 10,
                          padx = 10)
            ...
            with contextlib.redirect_stdout(outputContainer):
                ...
                while self.seqRunning:
                    if savedContent != outputContainer.getvalue():
                        self.newContent = outputContainer.getvalue().replace(savedContent, "")
                        savedContent = outputContainer.getvalue()
